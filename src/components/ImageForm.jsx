...
export default function ImageForm() {
  ...
  useEffect(() => {
    const fetchSpaces = async () => {
      try {
        const response = await fetch("https://spacer-backend-production.up.railway.app/spaces");
        if (!response.ok) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (imageFile) {
        ...
        response = await fetch("https://spacer-backend-production.up.railway.app/api/images", {
          method: "POST",
          headers: {
