...
function SpaceForm() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await fetch("https://spacer-backend-production.up.railway.app/categories");
  ...
  const onSubmit = async (values) => {
    ...
    const url = editingSpace
      ? `https://spacer-backend-production.up.railway.app/spaces/${editingSpace.id}`
      : "https://spacer-backend-production.up.railway.app/spaces";
